...
- 支持日志管理
- 支持多端口配置
- [支持自定义证书安装](https://github.com/nihaowohao/v2ray-agent/blob/master/documents/install_tls.md)
...
- wget: command not found [**这里需要自己手动安装下wget**]
  ，如未使用过Linux，[点击查看](https://github.com/nihaowohao/v2ray-agent/tree/master/documents/install_tools.md)安装教程
- 不支持非root账户
...
- **[如有使用不明白的地方请先查看脚本使用指南](https://github.com/nihaowohao/v2ray-agent/blob/master/documents/how_to_use.md)**
...
- **低版本脚本升级高版本时无法启动问题，[请点击此链接查看解决方案](https://github.com/nihaowohao/v2ray-agent/blob/master/documents/how_to_use.md#4%E4%BD%8E%E7%89%88%E6%9C%AC%E5%8D%87%E7%BA%A7%E9%AB%98%E7%89%88%E6%9C%AC%E5%90%8E%E6%97%A0%E6%B3%95%E5%90%AF%E5%8A%A8%E6%A0%B8%E5%BF%83)**

## [脚本使用指南](https://github.com/nihaowohao/v2ray-agent/blob/master/documents/how_to_use.md)、[脚本目录](https://github.com/nihaowohao/v2ray-agent/blob/master/documents/how_to_use.md#5脚本目录)
...
```
wget -P /root -N --no-check-certificate "https://raw.githubusercontent.com/nihaowohao/v2ray-agent/master/install.sh" && chmod 700 /root/install.sh && /root/install.sh
```

# 示例图

<img src="https://raw.githubusercontent.com/nihaowohao/v2ray-agent/master/fodder/install/install.jpg" width=700>

# 许可证

[GPL-3.0](https://github.com/nihaowohao/v2ray-agent/blob/master/LICENSE)

## Stargazers over time

[![Stargazers over time](https://starchart.cc/nihaowohao/v2ray-agent.svg)](https://starchart.cc/nihaowohao/v2ray-agent)
